...
const CreateTargetCompetition = lazy(() =>
    import("./../components/AdminPanel/Sales/TargetCompetition/CreateTargetCompetition")
);



const SalesRoutes = ({ contextData }) => {
    if (!contextData || !contextData[52] || contextData[52]?.view_value !== 1 && contextData[63]?.view_value !== 1) {
        return null;
    }
    return (
        <>
