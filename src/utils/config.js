export const baseUrl = "fhttps://jarvis.work:8080/api/"; // for production
// export const baseUrl = "http://34.42.47.106:8080/api/"; // for development
// export const baseUrl = "http://localhost:8080/api/"; // for naveen
...
export const socketBaseUrl = "https://socket.jarvis.work:8080"; // for production
