...
export default function AlertDialogforInsta({ open, setOpen, tj }) {
  ...
  let text = [
    ...
    "Please select the page which you want to Untrack",
    "Please select the posts for BulkUpload",
    "Please select the Decision for BulkPosts",
    "Please select the Campaign Name for BulkPosts",
  ];
  const titlearr = [
    ...
    "leads not selected?",
    "Employees not selected?",
    "Creators not selected",
    "Creators not selected",
    "Posts not selected",
    "No Decision Found",
    "Campaign Name not selected",
  ];
