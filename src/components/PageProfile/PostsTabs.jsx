...
import PagePaidPosts from "./PagePaidPosts";
...
import PageOverViewinPage from "./PageOverViewinPage";
      ...
      <div className="card pgTab">
        <TabContext value={overViewvalue}>
          <div className="card-header flex_center_between">
            <h5 className="cardHeaderTitle">Page Overview</h5>
            <TabList
              className="tabSM"
            ...
            >
              ...
              <Tab label="Previous Week" value={4} />
              <Tab label="Previous Month" value={5} />
              <Tab label="Previous Year" value={6} />
          ...
          <PageOverViewinPage
            value={overViewvalue}
            engagementArrayDateWise={engagementArrayDateWise}
          />
        </TabContext>
      </div>
