...
import { useGetIncentivePlanDetailsQuery, useUpdateIncentivePlanMutation } from "../../../Store/API/Sales/IncentivePlanApi";
...
const IncentiveUpdate = () => {
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <div className="card-body row">
          ...
          <div className="form-group col-4">
            ...
            />
            {
              isValid.sales_service_master_id === "" && <span className="form-error">Service Name is Required</span>
            }
          </div>
          <div className="col-4">
            ...
            />
            {
              isValid.incentive_type === "" && <span className="form-error">Incentive Type is Required</span>
            }
          </div>
          <div className="col-4">
            ...
            />
            {
              isValid.value === "" && <span className="form-error">Value is Required</span>
            }
          </div>
          <FieldContainer
            label={"Remarks"}
      ...
      <buton className="cmnbtn btn btn-primary mb-5" disabled={incentiveLoading} onClick={(e) => handleSubmit(e)}>
