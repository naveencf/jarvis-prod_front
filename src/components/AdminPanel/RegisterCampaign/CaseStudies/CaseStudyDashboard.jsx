...
export default function CaseStudyDashboard() {
  ...
  return (
    ...
    <div className="col-md-5" style={{ margin: '15px', flexBasis: 'calc(50% - 30px)' }}>
        <div className="card" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '10px', backgroundColor: '#f8f9fa', padding: '20px' }}>
            <div className="card-body">
                <h5 className="card-title" style={{ fontSize: '1.25rem', color: '#007bff' }}>Top 5 Highest Reach</h5>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total1 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total2 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total3 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total4 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total5 : {contentData.length}</p>
                <Link to="/data-content-type" className="btn btn-primary" style={{ backgroundColor: '#007bff', border: 'none', borderRadius: '5px', padding: '10px 20px', color: 'white', textDecoration: 'none' }}>View Content Type</Link>
            </div>
        </div>
    </div>
    <div className="col-md-5" style={{ margin: '15px', flexBasis: 'calc(50% - 30px)' }}>
        <div className="card" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '10px', backgroundColor: '#f8f9fa', padding: '20px' }}>
            <div className="card-body">
                <h5 className="card-title" style={{ fontSize: '1.25rem', color: '#007bff' }}>Top 5 Highest Impression</h5>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total1 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total2 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total3 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total4 : {contentData.length}</p>
    ...
    <div className="col-md-5" style={{ margin: '15px', flexBasis: 'calc(50% - 30px)' }}>
        <div className="card" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '10px', backgroundColor: '#f8f9fa', padding: '20px' }}>
            <div className="card-body">
                <h5 className="card-title" style={{ fontSize: '1.25rem', color: '#007bff' }}>Top 5 Highest Engagement</h5>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total1 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total2 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total3 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total4 : {contentData.length}</p>
    ...
    <div className="col-md-5" style={{ margin: '15px', flexBasis: 'calc(50% - 30px)' }}>
        <div className="card" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '10px', backgroundColor: '#f8f9fa', padding: '20px' }}>
            <div className="card-body">
                <h5 className="card-title" style={{ fontSize: '1.25rem', color: '#007bff' }}>Top 5 Highest Views</h5>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total1 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total2 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total3 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total4 : {contentData.length}</p>
    ...
    <div className="col-md-5" style={{ margin: '15px', flexBasis: 'calc(50% - 30px)' }}>
        <div className="card" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '10px', backgroundColor: '#f8f9fa', padding: '20px' }}>
            <div className="card-body">
                <h5 className="card-title" style={{ fontSize: '1.25rem', color: '#007bff' }}>Top 5 Highest Story Views</h5>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total1 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total2 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total3 : {contentData.length}</p>
                <p className="card-text" style={{ fontSize: '1rem' }}>Total4 : {contentData.length}</p>
