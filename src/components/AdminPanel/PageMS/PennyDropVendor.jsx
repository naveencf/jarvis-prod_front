...
function PennyDropVendor({ bankRows }) {
    ...
    const handlePennyDropforVendor = async (bankDetail) => {
        ...
        try {
            ...
            // Step 2: Call API
            const response = await axios.post(`${insightsBaseUrl}v1/create_penny_drope`, payload, {
        ...
        <>
            <div className="card">
                ...
                {bankRows.map((bankDetail, index) => (
                    <div key={index} className="bank-row" style={{ border: "1px solid #ddd", padding: "10px", marginBottom: "10px", borderRadius: "5px" }}>
