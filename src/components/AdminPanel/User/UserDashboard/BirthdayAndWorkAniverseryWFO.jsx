...
const BirthdayAndWorkAniverseryWFO = () => {
  const [birthdayData, setBirthdayData] = useState([]);
  const [workAnniversarieData, setWorkAnniversarieData] = useState([]);

  const getBirthData = async () => {
    const res = await axios.get(baseUrl + "get_wfo_users_birth_days");
    setBirthdayData(res.data.data);
  };
  const getAnniData = async () => {
    const res = await axios.get(baseUrl + "get_wfo_users_work_anniversary");
...
export default BirthdayAndWorkAniverseryWFO;
