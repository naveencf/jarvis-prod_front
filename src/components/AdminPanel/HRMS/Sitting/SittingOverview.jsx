        ...
        <Layer ref={layerRef}>
          ...
          {elements.map((el) => (
            <Path
              ...
              //   //   console.log(
              //   //     e.target.parent.children[i].attrs.id,
              //   //     e.target.parent.children[i]._lastPos,
              //   //     "drag"
              //   //   );
              //   // }
              //   console.log(e.target);

              //   const draggedNode = e.target.parent.children.slice(
              //     1,
              //     e.target.parent.children.length
              //   );

              //   const updatedElements = elements.map((element) => {
              //     if (selectedIds.includes(element.id)) {
              //       for (let i = 0; i < draggedNode.length; i++) {
              //         if (
              //           draggedNode[i]?.attrs?.id?.split("-")[1] == element.id
              //         ) {
              //           return {
              //             ...element,
              //             x: draggedNode[i].position().x,
              //             y: draggedNode[i].position().y,
              //           };
              //         } else return element;
              //       }
              //     }
              ...
              //     if (element.id === el.id)
              //       return { ...element, x: e.target.x(), y: e.target.y() };
              //     else return element;
              //   });
