...
import TDSDeductedFilters from "./Components/TDSDeductedFilters";
import TDSPaymentHistory from "./Components/TDSPaymentHistory";
import {
  TDSDeductedColumns,
  TDSDeductedUniqueVendorColumns,
...
export default function TDSdeduct() {
  ...
  const [uniqueVendorDialog, setUniqueVendorDialog] = useState(false);
  ...
  const handleOpenUniqueVendorClick = () => {
    setUniqueVendorDialog(true);
  };
  const handleCloseUniqueVendorClick = () => {
    setUniqueVendorDialog(false);
  };
  ...
  return (
    <div>
      ...
      <CommonDialogBox
        setDialog={setUniqueVendorDialog}
        dialog={uniqueVendorDialog}
        columns={TDSDeductedUniqueVendorColumns({
