...
const Calender = ({steps,startDate,setStartDate,endDate,setEndDate,generateDates,handleStepChange,handleDatePostCountChange,resetCalendar,dates,selectedStep,dailyTotals,overviewData ,postCounts , addDate}) => {
  return (
   <>
