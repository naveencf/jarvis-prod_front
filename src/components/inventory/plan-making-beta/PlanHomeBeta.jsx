  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <CostUpdateModal isOpen={isCostModalOpen} onClose={() => setIsCostModalOpen(false)} formData={priceFormData} onChange={handleCostInputChange} onUpdate={handleCostUpdate} isLoading={isLoading} />
        <div className="tabs">
