          ...
          <div className="row p16 pb-3 border-bottom">
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right">
                <h6 class="colorMedium ">Total Followers</h6>
                <h6 class="colorDark">{formatFollowers(totalFollowers)}</h6>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right">
                <h6 class="colorMedium ">Total Cost</h6>
                <h6 class="colorDark">{totalCost}</h6>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right">
                <h6 class="colorMedium ">Total Posts / Page</h6>
                <h6 class="colorDark">{totalPostsPerPage}</h6>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right">
                <h6 class="colorMedium ">Total Stories / Page</h6>
                <h6 class="colorDark">{totalStoriesPerPage}</h6>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right">
                <h6 class="colorMedium ">Total Deliverable</h6>
                <h6 class="colorDark">{totalDeliverables}</h6>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-6 col-12">
              <div className="flexCenter colGap12 border-right border-0">
                <h6 class="colorMedium ">Total Pages</h6>
                <h6 class="colorDark">{totalPagesSelected}</h6>
              </div>
            </div>
            {/* <hr /> */}
          </div>
          ...
          <div className="row pl16 pr16 border-bottom">
            {Object.entries(pageCategoryCount)?.map(([categoryId, count]) => {
              ...
              return (
                ...
                >
                  <div>
                    <div class="flexCenter colGap14">
                      <div
                        class="iconBadge small bgPrimaryLight m-0"
                        onClick={handleToggleBtn}
                      >
                        <h5>{count}</h5>
                      </div>
                      <div>
                        <h6 class="colorMedium">Category</h6>
                        <h6 class="mt4 fs_16">{categoryName}</h6>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div onClick={handleOwnPage}>
                <div class="flexCenter colGap14">
                  <div class="iconBadge small bgPrimaryLight m-0">
                    <h5>{ownPages?.length - selectedRow?.length}</h5>
                  </div>
                  <div>
                    <h6 class="colorMedium">Own Remaining Pages</h6>
                    <h6 class="mt4">
            ...
            {["own", "vendor", "solo"].map((type) => (
              <div className="col-lg-4 col-md-4 col-sm-6 col-12" key={type}>
                <div onClick={handleOwnPage}>
                  <div class="flexCenter colGap14">
                    <div
                      class="iconBadge small bgInfoLight m-0"
                      onClick={() =>
                        handleOpenModal(
