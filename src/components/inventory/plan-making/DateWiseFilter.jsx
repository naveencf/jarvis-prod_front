...
const DateWiseFilter = ({ planRows, setFilteredPlanRows, setPlanxLoading }) => {
  ...
  const {
    data,
    error,
    isLoading: isPlanxLoading,
    isFetching: isPlanxFetching,
  ...
  useEffect(() => {
    setPlanxLoading(isPlanxFetching || isPlanxLoading);
  }, [isPlanxFetching, isPlanxLoading]);
