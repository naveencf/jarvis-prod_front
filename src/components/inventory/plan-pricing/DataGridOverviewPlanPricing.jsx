...
const DataGridOverviewPlanPricing = ({ handleOpenDialog, handleStatusChange, handleDuplicateClick, handleRowClick, handleEditClick }) => {
...
export default DataGridOverviewPlanPricing;
