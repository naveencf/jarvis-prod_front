...
const PaginationComp = ({ data, currentPage, setCurrentPage, itemsPerPage, setItemsPerPage, Pagination, originalData, columnsheader, isPagination }) => {
    useEffect(() => {
        setCurrentPage(1);
    }, [itemsPerPage]);
    return (
        <div className="footer-pagination">
            {isPagination && (<>
                <div className="pagination">
                    ...
                    >
                        <svg fill="var(--medium)" height="13px" width="13px" version="1.1" id="Layer_1"
