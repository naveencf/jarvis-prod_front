          ...
          >
            <div className="action_heading">
              ...
              <div className="action_btns">
                ...
                <button
                  type="button"
                  className={`btn ${id == 1 ? "btn-primary" : "btn-outline-primary"
                    } btn-sm`}
                ...
                <button
                  type="button"
                  className={`btn ${id == 2 ? "btn-primary" : "btn-outline-primary"
                    } btn-sm`}
                ...
                <button
                  type="button"
                  className={`btn ${id == 0 ? "btn-primary" : "btn-outline-primary"
                    } btn-sm`}
